...
| portal.server.licenseServer.image.tag | string | `"2.7.0"` |  |
...
| portal.server.licenseServer.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| portal.server.licenseServer.securityContext.readOnlyRootFilesystem | bool | `true` |  |
| portal.server.licenseServer.securityContext.runAsNonRoot | bool | `true` |  |
| portal.server.licenseServer.securityContext.runAsUser | int | `2000` |  |
